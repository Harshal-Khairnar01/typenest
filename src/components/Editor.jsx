...
const Editor = ({ onSave, initialData }) => {
  ...
  return (
    <section className=" mx-auto lg:px-10 mt-2">
      <form
        className=" space-y-4"
      ...
      >
        ...
        <input
          ...
          type="text"
        />
        <h2 className=" text-lg font-bold">SEO Data</h2>
        ...
        <div className=" flex gap-2">
          <select
            {...register("status")}
            className=" font-bold text-lg bg-zinc-800 px-3 py-1 rounded-sm outline-none"
          >
          ...
          <button
            type="submit"
            className=" bg-zinc-800 px-3 py-2 rounded cursor-pointer hover:bg-black transition-all duration-300"
          >
            Save
          </button>
        </div>
